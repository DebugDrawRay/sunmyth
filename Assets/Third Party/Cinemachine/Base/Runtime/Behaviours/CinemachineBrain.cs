...
namespace Cinemachine
{
    ...
    public class CinemachineBrain : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            if (m_UpdateMethod == UpdateMethod.SmartUpdate)
                UpdateVirtualCameras(CinemachineCore.UpdateFilter.Update, deltaTime * GetSubframeCount());
            else if (m_UpdateMethod == UpdateMethod.LateUpdate)
                UpdateVirtualCameras(CinemachineCore.UpdateFilter.Any, deltaTime * GetSubframeCount());
